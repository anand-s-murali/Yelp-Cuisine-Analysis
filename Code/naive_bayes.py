...
def main():
    ...
    for alpha in alphas:
        ...
        validation_accuracy = accuracy_score(y_val, y_pred) * 100
        ...
        # append the alpha, accuracy pair to the results array
        results.append([alpha, validation_accuracy])

    # tabulate and pretty-print the results of hypertuning
    print(tabulate(results, headers=["Alpha", "Validation Accuracy"]))
    print()
    ...
    print(f"Testing Accuracy for alpha value {best_alpha}: {test_accuracy}%")
